...
#### CASE STUDY: std::vector::push_back(*)

std::vector 中有兩個的元素：容量 (capacity) 和長度 (size) ，分別代表擁有的空間以及實際儲存了元素的空間大小，其均攤分析如下：

<figure><center><img src="{{ site.baseurl }}/picture/push_back.png" width="100%"></center></figure>
